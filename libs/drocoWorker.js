/* draco decoder */
export default function createDrpcpWorker() {
    var $jscomp = $jscomp || {};
    ...
    var DracoDecoderModule = (function () {
        var f =
            "undefined" !== typeof document && document.currentScript
                ...
                : "http://127.0.0.1:8080/three/examples/js/libs/draco/draco_decoder.js";
        ...
        return function (m) {
            ...
            if (oa) {
                ...
                Z
                    ...
                    : document && document.currentScript && (M = document.currentScript.src),
                    f && (M = f),
            ...
            if (
                (ia = a.wasmMemory ? a.wasmMemory : new WebAssembly.Memory({ initial: Ja / 65536 }))
            )
                var ka = ia.buffer;
            Ja = ka.byteLength;
            l(ka);
                ...
                La = (function () {
                    ...
                    (function () {
                        ...
                        fetch(U, { credentials: "same-origin" }).then(function (a) {
                            console.log(a);
                            return WebAssembly.instantiate(a, d).then(c, function (a) {
